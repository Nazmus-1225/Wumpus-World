    ...
    updateAdjacentRisk(adjacentCell: Cell) {
      ...
      switch (adjacentCell.type) {
        case CellType.Breeze:
          ...
          adjacentCell.risk_score = Math.max(adjacentCell.risk_score, adjacentCell.pit_probability, adjacentCell.wumpus_probability, adjacentCell.treasure_probability);  
          break;
